...
def main():
    ...
    for it in items:
        ...
        rec = {
            ...
            "recorded_date": published or "",          # reuse; you can later split recorded vs published
            "channel": channel,
            "source_type": guess_source_type(channel, archival_title),
            "themes": [],
            "transcript": to_transcript_path(stem),
            "diarist": to_diarist_path(stem),
        ...
        # Normalize blob/raw URLs to point at /sources/transcripts/ path
        update_blob_urls(rec, stem)
